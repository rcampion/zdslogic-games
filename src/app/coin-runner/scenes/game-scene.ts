...
export class GameScene extends Phaser.Scene {
  ...
  preload(): void {
    this.load.image('background', './assets/coin-runner/assets/images/background.png');
    this.load.image('player', './assets/coin-runner/assets/images/player.png');
    this.load.image('coin', './assets/coin-runner/assets/images/coin.png');
  }
